...
const NavBar = () => {
  ...
  const appBarButtons = (
    <Box sx={{ display: "flex", ml: "auto", alignItems: "center" }}>
      <Button sx={{  fontFamily:"montserrat" }}
        variant="text"
        color="inherit"
      ...
      <Button sx={{  fontFamily:"montserrat" }} color="inherit" onClick={() => scrollTo("Education")}>
        Education
      </Button>
      <Button sx={{  fontFamily:"montserrat" }} color="inherit" onClick={() => scrollTo("Projects")}>
        Projects
      </Button>
      <Button sx={{  fontFamily:"montserrat" }} color="inherit" onClick={() => scrollTo("Contact")}>
        Contact
      </Button>
    </Box>
  );
    ...
    <AppBar position="fixed" color="primary">
      <Toolbar>
        <Stack direction="row" alignItems="center" gap={1} sx={{ flexGrow: 1 }}>
          <Typography sx={{  fontFamily:"montserrat" }}variant="h6">Sahil</Typography>
